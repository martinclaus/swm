...
def rhs(u,v,eta, param):
    ...
    """
    from swm_param import f_q, Fx
    from swm_operators import (ITu, ITv, ITq, IuT, IvT,
                               Gux, Gvx, Gvy, Guy, G2vx, G2uy, GTx, GTy, Gqx, Gqy,
                               AL1, AL2, ALeur, ALeul, ALpvu, ALpvd,
                               Seur, Sau, Seul, Sbu, Scu, Sdu, Spvu, Spvd, Sav,
                               Sbv, Scv, Sdv,
                               indx_au, indx_bu, indx_cu, indx_du, indx_av,
                               indx_bv, indx_cv, indx_dv)
